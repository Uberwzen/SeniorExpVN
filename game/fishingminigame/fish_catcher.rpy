...
init:
    image bg background = "assets/minigame_fish_catcher/background.png"
    ...
    python:
        ...
        class Fish():
            def __init__( self ):
                self.image = Image( "assets/minigame_fish_catcher/fish.png" )
                self.active = False
        ...
        class Player():
            def __init__( self ):
                self.image = Image( "assets/minigame_fish_catcher/dog.png" )
                self.dimensions = [ 100, 150 ]
